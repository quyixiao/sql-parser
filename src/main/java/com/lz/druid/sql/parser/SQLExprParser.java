...
import com.lz.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
...
//        expr = equalityRest(expr);
    ...
    public final SQLExpr inRest(SQLExpr expr) {
        ...
        } else if (lexer.token == Token.CONTAINS) {         //contains
            lexer.nextTokenLParen();
